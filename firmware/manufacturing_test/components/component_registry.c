...
extern const component_test_event_t *bmi270_test_event(void);
extern void bmi270_test_stop(void);
extern void bmp388_test_start(const component_test_parameters_t *parameters);
